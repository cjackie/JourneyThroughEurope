...
public class Main extends Application {
    ...
    public enum JourneyPropertyType {
        ...
        DATA_PATH, ABOUT_FILE, HISTORY_TEXT, SPLASH_IMG, CITY_NEIGHBOR_FILE, SEA_NEIGBOR_FILE,
        CITIES, CARDS,DICE_SIDES,DICE_IMG_FORMAT,FLIGHT_TXT,PIECE_PATH_FORMAT,TOWN_INFO_TEXT,
        NUM_FLIGHT_PLANS, SAVED_DATA_TEXT,
        /* WINDOW */
        WINDOW_WIDTH, WINDOW_HEIGHT, WINDOW_TITLE,
        /*path of images*/
        FLIGHT_IMG, MAP_IMG_0, MAP_IMG_1, MAP_IMG_2, MAP_IMG_3,
        MAP_IMGO_0, MAP_IMGO_1, MAP_IMGO_2, MAP_IMGO_3,CONGRATZ_IMG,
        /*game stuff*/
        GAME_WIDTH, GAME_HEIGHT, FLIGHT_IMG_HEIGHT, FLIGHT_IMG_WIDTH,LEFT_SEC_WIDTH,
        RIGHT_SEC_WIDTH, SPLASH_WIDTH, SPLASH_HEIGHT,GAME_ORIGINAL_HEIGHT,
        GAME_ORIGINAL_WIDTH,RADIUS,FLIGHT_ORIGINAL_HEIGHT, FLIGHT_ORIGINAL_WIDTH,CONGRATZ_WIDTH,
        CONGRATZ_HEIGHT,
        /*text string*/
        ...
        NAME,HISTORY_HEADER,START_BTN, LOAD_BTN, END_BTN,
        /*game config stuff*/
