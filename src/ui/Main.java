...
public class Main extends Application {
    ...
    public enum JourneyPropertyType {
        ...
        DATA_PATH, ABOUT_FILE, HISTORY_TEXT, SPLASH_IMG, CITY_NEIGHBOR_FILE, CITIES,
        CARDS,DICE_SIDES,DICE_IMG_FORMAT,FLIGHT_TXT,PIECE_PATH_FORMAT,
        NUM_FLIGHT_PLANS,
        /* WINDOW */
